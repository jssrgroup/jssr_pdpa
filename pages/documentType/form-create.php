                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select select2" id="parent" name="parent" data-placeholder="ค้นหาด้วยชื่อ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <small id="expireHelp" class="form-text text-muted">Ex. 90</small>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
        ...
        $(function() {
            ...
            $('#formData').submit(function(e) {
                ...
                messages: {
                    ...
                    // parent: {
                    //     required: "เลือก ภายใต้เอกสาร",
                    // },
                    // pattern: {
                    //     required: "รูปแบบ ห้ามเว้นว่าง",
                    // },
                    expire: {
